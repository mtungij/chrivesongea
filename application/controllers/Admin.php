...
// }
  ...
  public function all_previous_income(){
	...
	public function create_income_detail(){
        ...
        $massage = 'Ndugu, ' .$first_name . ' ' .$midle_name . ' ' .$last_name . ' ' .'Umelipa faini ya Tsh.'. number_format($penart_paid) . ' '.$comp_name .' kwa msaada 0626027242';
...
public function sendsms($phone,$massage){
  ...
  $token = "14|5DY9eqGQZ3e7NC9BmozFeUXnIfYNAnoxmDZIQnSqae751c33";
